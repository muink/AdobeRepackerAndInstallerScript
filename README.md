...
# CAUTION!
Please, don't use this branch's content for piracy things. I put this patched binaries for who wants to install their unpacked HyperDrive-based Adobe application installers for various reasons. My reason was maximize deduplication ratings on my Windows Server Storage Spaces storage to store more programs.
  ...
  - To patch dll's:
    ...
    # - On AdobePIM.dll (on 6.5.0.348):
      - Probably you can use this method for all versions.
        ...
        - On IDA Pro, search for string "File '%s' is corrupted. OCEError: %d".
